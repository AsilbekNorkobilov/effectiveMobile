    ...
    public OpenAPI openAPI() {
        return new OpenAPI().addSecurityItem(new SecurityRequirement().
                ...
                .info(new Info().title("Task Management System API")
                        .description("""
                                There are 2 Users which already registrated
                                1 email: ivan@gmail.com password: root123 role:ROLE_AUTHOR
                                2 email: petr@gmail.com password: root123 role:ROLE_EXECUTOR
                                """)
